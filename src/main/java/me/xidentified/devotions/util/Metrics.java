...
public class Metrics {
    ...
    public static class MetricsBase {
         ...
         * @param submitTaskConsumer          A consumer that takes a runnable with the submit task. This can be used to
         *                                    delegate the data collection to a another thread to prevent errors caused
