...
public class Messages {
    ...
    public static final Message DEVOTION_SET = new MessageBuilder("devotion.set")
            ...
            .build();
    public static final Message DEVOTION_MUST_ABANDON = new MessageBuilder("devotion.must_abandon")
            .withDefault("<prefix_negative>Use '/deity abandon' to remove your current devotion before making another.")
            .build();
    ...
    public static final Message DEITY_CMD_USAGE = new MessageBuilder("deity.cmd.usage")
            .withDefault("<offset>Usage: <cmd_syntax>/deity list|select|info|abandon DeityName</cmd_syntax>")
            .build();
    ...
    public static final Message SHRINE_LIMIT_REACHED = new MessageBuilder("shrines.limit_reached")
            ...
            .build();
    public static final Message SHRINE_FOLLOW_DEITY_TO_DESIGNATE = new MessageBuilder(
            "shrines.follow_deity_to_designate")
    ...
    public static final Message SHRINE_COOLDOWN = new MessageBuilder("shrines.cooldown")
            .withDefault(
                    "<prefix_negative>You must wait {cooldown:'m'}m {cooldown:'s'}s before performing another ritual.")
            .build();
    ...
    public static final Message FAVOR_CMD_USAGE = new MessageBuilder("favor.cmd.usage")
            .withDefault(
                    "<prefix_warning>Usage: <cmd_syntax>/favor <arg>set|give|take</arg> <arg>playername</arg> <arg>amount</arg></cmd_syntax>")
            .build();
    public static final Message FAVOR_CMD_PLAYER_DOESNT_WORSHIP = new MessageBuilder(
            "favor.cmd.player_does_not_worship")
    ...
    public static final Message RITUAL_CMD_USAGE = new MessageBuilder("ritual.cmd.usage")
            .withDefault(
                    "<prefix_warning>Usage: <cmd_syntax>/ritual <arg>info</arg> <arg_opt>RitualName</arg_opt></cmd_syntax>")
            .build();
